    ...
    >
      ...
      <div style={{ display: "flex", flex: 1, overflow: "hidden" }}>
        ...
        >
          ...
          {activeModule === "users" && <ModuleUsers />}

          {activeModule === "schools" && <ModuleSchools />}

          {activeModule === "school-roles" && <ModuleSchoolRoles />}

          {activeModule === "academic-structure" && <ModuleAcademicStructure />}

          {activeModule === "academic-plans" && <ModuleAcademicPlans />}
          ...
          {activeModule === "invoices" && (
            <PlatformTable
              ...
              columns={[
                ...
                {
                  header: "Monto Total",
                  accessor: (r) => `$${r.total_amount} ${r.currency || "USD"}`,
                },
