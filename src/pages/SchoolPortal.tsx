...
export default function SchoolPortal() {
  ...
  let userProfile: { first_name: string; role: string } = {
    first_name: "Usuario",
    role: "colaborador",
  };
  try {
    const rawUser = localStorage.getItem("user");
    if (rawUser) userProfile = JSON.parse(rawUser) as typeof userProfile;
  } catch {}
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "1.2rem" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "0.8rem" }}>
            ...
            <div>
              ...
              <span
                style={{ fontSize: "0.7rem", color: "var(--color-text-muted)", fontWeight: 500 }}
              >
                Portal Escolar
              </span>
            </div>
      ...
      <div style={{ display: "flex", flex: 1, overflow: "hidden" }}>
        ...
        <aside
          style={{
            ...
            background: "white",
            borderRight: "1px solid rgba(45, 55, 63, 0.1)",
            display: "flex",
            flexDirection: "column",
            flexShrink: 0,
        ...
        >
          ...
          >
            ...
            <div
              ...
              onMouseEnter={(e) =>
                !isCollapsed && (e.currentTarget.style.background = "rgba(45, 55, 63, 0.03)")
              }
              onMouseLeave={(e) =>
                !isCollapsed && (e.currentTarget.style.background = "transparent")
              }
            >
              <div
                style={{
        ...
        {/* ─── Main Content ─── */}
        <main
          style={{ flex: 1, padding: "2.5rem", overflowY: "auto", background: "var(--color-bg)" }}
        >
          {activeModule === "home" && (
            <>
              {/* Welcome Banner */}
              <div
                style={{
                  background:
                    "linear-gradient(135deg, rgba(211, 73, 55, 0.08), rgba(224, 159, 57, 0.08))",
                  borderRadius: "20px",
                  padding: "2.5rem",
                  marginBottom: "2rem",
                  border: "1px solid rgba(45, 55, 63, 0.05)",
                }}
              >
                <h1
                  style={{ fontSize: "2rem", margin: "0 0 0.5rem 0", color: "var(--color-text)" }}
                >
                  ¡Bienvenido, {displayName}! 👋
                </h1>
                <p style={{ color: "var(--color-text-muted)", margin: 0, fontSize: "1.05rem" }}>
                  Estás conectado al portal escolar. Tu rol es{" "}
                  <strong style={{ color: "var(--color-secondary)", textTransform: "capitalize" }}>
                    {displayRole}
                  </strong>
                  .
                </p>
                ...
                {[
                  {
                    ...
                    bg: "rgba(105, 151, 126, 0.1)",
                  },
                  {
                    label: "Mensajes",
                    icon: MessageSquare,
                    color: "var(--color-secondary)",
                    bg: "rgba(224, 159, 57, 0.1)",
                  },
                  {
                    label: "Asistencia",
                    icon: ClipboardList,
                    color: "var(--color-primary)",
                    bg: "rgba(211, 73, 55, 0.08)",
                  },
                ].map((card) => (
                  <div
                    key={card.label}
                    style={{
                      ...
                      padding: "1.8rem",
                      borderRadius: "16px",
                      border: "1px solid rgba(45, 55, 63, 0.08)",
                  ...
                  >
                    ...
                    >
                      <div>
                        ...
                        <h3 style={{ fontSize: "2rem", margin: 0, color: "var(--color-text)" }}>
                          —
                        </h3>
                      </div>
                      <div
                  ...
                  >
                    {[
                      ...
                      { k: "Dirección", v: meData.address || "No registrada" },
                      {
                        ...
                        v: meData.emergency_contact_name || "No registrado",
                      },
                    ].map((item) => (
                      <div key={item.k}>
                        <span
          ...
          {activeModule === "profile" && meData && (
            <div>
              <h1 style={{ fontSize: "2rem", margin: "0 0 2rem", color: "var(--color-text)" }}>
                Mi Perfil
              </h1>
                    ...
                    >
                      {[
                        ...
                        { k: "Teléfono", v: meData.phone || "No registrado" },
                        {
                          ...
                          v: meData.birth_date
                            ? new Date(meData.birth_date).toLocaleDateString()
                            : "No registrada",
                        },
                      ].map((item) => (
                        <div key={item.k}>
                      ...
                      <div>
                        ...
                        <span style={{ color: "var(--color-text)" }}>
                          {meData.emergency_contact_name || "No registrado"}{" "}
                          {meData.emergency_contact_phone
                            ? `(${meData.emergency_contact_phone})`
                            : ""}
                        </span>
                      </div>
          ...
          {["school-users", "profesor", "alumno"].includes(activeModule) && meData && (
            <ModuleSchoolUsers
              ...
              initialFilter={
                activeModule === "profesor" ? "profesor" : activeModule === "alumno" ? "alumno" : ""
              }
            />
          )}
