    ...
    <>
      ...
      <section className="hero container">
        <div className="hero-content">
          <div className="hero-text">
            ...
            <p>
              Plataforma integral con tecnología moderna y sólidas raíces andinas. Centraliza notas,
              facturación y comunicación en un solo lugar.
            </p>
      ...
      <section className="features container" id="features">
        ...
        >
          ...
          <p>
            Todo lo que tu institución educativa necesita para crecer, organizado y listo para usar.
          </p>
        </div>
        ...
        <div className="features-grid">
          <div className="glass-card">
            ...
            <p>
              Control total sobre notas, asistencia, horarios y seguimiento personalizado de los
              estudiantes.
            </p>
          </div>
          ...
          <div className="glass-card">
            <div
              ...
              style={{ color: "var(--color-secondary)", background: "rgba(227, 180, 72, 0.1)" }}
            >
              <Receipt size={28} />
            </div>
            <h3>Facturación Integrada</h3>
            <p>
              Automatiza los cobros, mensualidades e integra pasarelas de pago para facilitar la
              gestión comercial.
            </p>
          </div>
          ...
          <div className="glass-card">
            <div
              className="feature-icon-wrapper"
              style={{ color: "var(--color-tertiary)", background: "rgba(82, 142, 115, 0.1)" }}
            >
              <MessageSquare size={28} />
            </div>
            <h3>Comunicación Eficiente</h3>
            <p>
              Notificaciones y comunicados para mantener a los padres y profesores siempre
              conectados.
            </p>
          </div>
          ...
          <div className="glass-card">
            <div
              className="feature-icon-wrapper"
              style={{ color: "var(--color-bg)", background: "var(--color-text)" }}
            >
              <Users size={28} />
            </div>
            <h3>Multi-Roles</h3>
