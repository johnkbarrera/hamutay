...
export default function SchoolDashboard() {
  ...
  const [roles, setRoles] = useState<Array<{ id: string; name: string; category?: string }>>([]);
  ...
  let userProfile: { first_name: string; role: string; name?: string } = {
    first_name: "Usuario",
    role: "invitado",
  };
  try {
    ...
    if (rawUser) {
      userProfile = JSON.parse(rawUser) as typeof userProfile;
    }
  } catch {}
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const url = editingUser
        ? `${API_URL}/platform/schools/${id}/users/${editingUser.id}`
        : `${API_URL}/platform/schools/${id}/users`;
  ...
  const handleDelete = async (userId) => {
    if (!window.confirm("¿Desactivar y mover este usuario a la papelera? Perderá su acceso."))
      return;
    try {
      const token = localStorage.getItem("token");
    ...
    return (
      ...
      >
        ...
        <p style={{ marginTop: "1rem", color: "var(--color-text-muted)" }}>
          Cargando infraestructura escolar...
        </p>
      </div>
    );
  }
    ...
    >
      ...
      <header
        style={{
          height: "70px",
          background: "white",
          borderBottom: "1px solid rgba(45, 55, 63, 0.1)",
          display: "flex",
          alignItems: "center",
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "0.8rem" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column" }}>
              <span style={{ fontSize: "0.9rem", fontWeight: "600", color: "var(--color-text)" }}>
                {userProfile.first_name || userProfile.name || "Usuario"}
              </span>
              <span
                style={{
                  fontSize: "0.75rem",
      ...
      <div style={{ display: "flex", flex: 1, overflow: "hidden" }}>
        ...
        <aside
          style={{
            ...
            background: "white",
            borderRight: isCollapsed ? "none" : "1px solid rgba(45, 55, 63, 0.1)",
            display: "flex",
            flexDirection: "column",
            alignItems: "center",
            paddingTop: "1.5rem",
          ...
          >
            <div
              style={{
                ...
                overflow: "hidden",
                flexShrink: 0,
                padding: school.logo_url ? 0 : "1rem",
                background: "rgba(45, 55, 63, 0.02)",
              }}
            >
              {school.logo_url ? (
                <StorageImage
                  fileKey={school.logo_url}
                  fallbackName={school.name}
                  alt="Logo de Colegio"
            ...
            <div style={{ flex: 1 }}>
              ...
              >
                <div>
                  <h1
                    style={{ fontSize: "2rem", margin: "0 0 0.2rem 0", color: "var(--color-text)" }}
                  >
                    {school.name}
                  </h1>
                  <p style={{ color: "var(--color-text-muted)", margin: 0, fontSize: "0.9rem" }}>
                    Dominio interno: <strong>{school.slug}</strong> | Tipo:{" "}
                    <strong>{school.institution_type === "private" ? "Privado" : "Estatal"}</strong>
                  </p>
                </div>
                <span
                  style={{
              ...
              <div style={{ display: "flex", gap: "2rem", marginTop: "1.5rem", flexWrap: "wrap" }}>
                ...
                >
                  ...
                  {school.district || school.province || "Geografía no definida"}
                </div>
                {school.website && (
                  <div
                    style={{
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
                <select
                  ...
                  style={{
                    ...
                    outline: "none",
                    fontSize: "0.85rem",
                    color: filterRole ? "var(--color-text)" : "var(--color-text-muted)",
                    background: "white",
                    cursor: "pointer",
                  }}
                >
            ...
            <div style={{ minHeight: "250px" }}>
              {usersLoading ? (
                <div style={{ display: "flex", justifyContent: "center", padding: "4rem 0" }}>
                  <Loader2
                    size={32}
                    style={{ animation: "spin 1s linear infinite", color: "var(--color-tertiary)" }}
                  />
                </div>
              ) : (
                    ...
                    <tbody>
                      ...
                      {filteredUsers.length === 0 && (
                        <tr>
                          ...
                          >
                            No encontramos registros disponibles.
                          </td>
                        </tr>
                      )}
                    </tbody>
          ...
          >
            ...
            >
              <div style={{ display: "flex", alignItems: "center", gap: "0.8rem" }}>
                ...
                <h2 style={{ fontSize: "1.3rem", margin: 0, color: "var(--color-text)" }}>
                  {editingUser ? "Ajustar Expediente" : "Provisionar Usuario de Colegio"}
                </h2>
              </div>
              <button
            ...
            >
              <div style={{ display: "flex", gap: "2rem" }}>
                ...
                >
                  <div
                    style={{
                      ...
                      borderRadius: "50%",
                      background: "rgba(45, 55, 63, 0.05)",
                      border: "2px dashed rgba(45, 55, 63, 0.2)",
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                      overflow: "hidden",
                  ...
                  >
                    {avatarPreview ? (
                      ...
                      <StorageImage
                        fileKey={editingUser.avatar_path}
                        alt="Avatar"
                        style={{ width: "100%", height: "100%", objectFit: "cover" }}
                      />
                    ) : (
                ...
                <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: "1rem" }}>
                  ...
                  >
                    <div>
                      <label className="input-label">Correo (Email) *</label>
                      <input
                        required
                        type="email"
                        name="email"
              ...
              <div
                style={{ display: "grid", gridTemplateColumns: "100px 1fr 1fr 1fr", gap: "1.2rem" }}
              >
                <div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleFormChange}
                    className="sys-input"
                    style={{ color: formData.birth_date ? "inherit" : "var(--color-text-muted)" }}
                  />
                </div>
              </div>
              ...
              >
                ...
                <div>
                  <label className="input-label">Emergencia (Persona)</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="input-label">Emergencia (Telf)</label>
                  <input
                    type="text"
              ...
              <fieldset
                style={{
                  border: "1px solid rgba(105, 151, 126, 0.3)",
                  borderRadius: "12px",
                  padding: "1rem",
                  background: "rgba(105, 151, 126, 0.02)",
                  marginTop: "0.5rem",
                }}
              >
                <legend
                ...
                >
                  <Shield size={14} /> Autorizaciones
                </legend>
                <label className="input-label">Rol Jerárquico *</label>
                {roles.length === 0 ? (
                  <div style={{ color: "#B91C1C", fontSize: "0.85rem", width: "100%" }}>
              ...
              {formMsg.text && (
                <div
                  style={{
                    background: formMsg.type === "success" ? "#D1FAE5" : "#FEE2E2",
                    color: formMsg.type === "success" ? "#065F46" : "#B91C1C",
                    padding: "0.8rem 1rem",
                    borderRadius: "8px",
                    fontSize: "0.9rem",
                  }}
              ...
              >
                ...
                <button
                  ...
                  style={{
                    ...
                    alignItems: "center",
                    gap: "0.5rem",
                    opacity: submitting || roles.length === 0 ? 0.6 : 1,
                  }}
                >
                  {submitting && (
                    <Loader2 size={16} style={{ animation: "spin 1s linear infinite" }} />
                  )}{" "}
                  Mapear en Base de Datos
                </button>
              </div>
            </form>
          </div>
        ...
        >
          ...
          >
              ...
              <div style={{ display: "flex", gap: "1.2rem", alignItems: "center" }}>
                ...
                >
                  {viewingUser.avatar_path ? (
                    <StorageImage
                      fileKey={viewingUser.avatar_path}
                      alt="Avatar"
                      style={{ width: "100%", height: "100%", objectFit: "cover" }}
                    />
                  ) : (
                ...
                <div>
                  ...
                  >
                    {getRoleName(viewingUser.role_id).toUpperCase()}
                  </p>
                </div>
              </div>
              <button
            ...
            >
              ...
              >
                <span
                  style={{ color: "var(--color-text-muted)", fontWeight: 600, fontSize: "0.85rem" }}
                >
                  Documento:
                </span>
                <span style={{ color: "var(--color-text)", fontSize: "0.9rem", fontWeight: 500 }}>
                  {viewingUser.id_type} {viewingUser.id_number}
                </span>
              </div>
              <div
                style={{
              ...
              >
                ...
                <span style={{ color: "var(--color-text)", fontSize: "0.9rem", fontWeight: 500 }}>
                  {viewingUser.phone || "No registrado"}
                </span>
              </div>
              <div
                style={{
              ...
              >
                ...
                <span style={{ color: "var(--color-text)", fontSize: "0.9rem", fontWeight: 500 }}>
                  {viewingUser.birth_date
                    ? new Date(viewingUser.birth_date).toLocaleDateString()
                    : "No registrada"}
                </span>
              </div>
              <div
              ...
              >
                ...
                <span style={{ color: "var(--color-text)", fontSize: "0.9rem", fontWeight: 500 }}>
                  {viewingUser.address || "No registrada"}
                </span>
              </div>
              <div style={{ display: "flex", flexDirection: "column", gap: "0.3rem" }}>
                ...
                <span style={{ color: "var(--color-text)", fontSize: "0.9rem", fontWeight: 500 }}>
                  {viewingUser.emergency_contact_name
                    ? `${viewingUser.emergency_contact_name} (${viewingUser.emergency_contact_phone || "Sin número"})`
                    : "No registrada"}
                </span>
              </div>
            </div>
