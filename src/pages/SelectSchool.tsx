      ...
      <div style={{ width: "100%", maxWidth: "480px" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "2.5rem" }}>
          <img
            src="/bear-logo.png"
            alt="Hamutay"
            style={{ width: "48px", height: "48px", borderRadius: "12px", marginBottom: "1rem" }}
          />
          <h1 style={{ fontSize: "1.8rem", color: "var(--color-text)", margin: "0 0 0.5rem" }}>
              ...
              style={{
                ...
                boxShadow:
                  selectingId === school.id
                    ? "0 4px 20px rgba(211, 73, 55, 0.15)"
                    : "0 2px 8px rgba(45, 55, 63, 0.04)",
                borderColor:
                  selectingId === school.id ? "var(--color-primary)" : "rgba(45, 55, 63, 0.1)",
